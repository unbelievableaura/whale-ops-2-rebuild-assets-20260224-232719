        ...
        >
          <div className="flex items-center justify-center gap-2 sm:gap-4 py-1.5 sm:py-2.5 px-2 sm:px-4">
            ...
            <div className="flex items-center gap-1 sm:gap-2">
              <span className="text-[12px] sm:text-sm font-bold tracking-[0.1em] sm:tracking-[0.15em] text-white/80 uppercase">
                FOLLOW
              </span>
              <a 
                href="https://x.com/BlackOpsWhale" 
                target="_blank" 
                rel="noopener noreferrer"
                className="text-[12px] sm:text-sm font-bold tracking-[0.1em] sm:tracking-[0.15em] text-cod-orange hover:text-white transition-colors uppercase"
              >
                @BLACKOPSWHALE
              </a>
              <span className="text-[12px] sm:text-sm font-bold tracking-[0.1em] sm:tracking-[0.15em] text-white/80 uppercase">
