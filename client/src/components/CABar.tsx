        ...
        >
          <div className="flex items-center justify-center gap-4 py-1 px-4">
            ...
            <div className="flex items-center gap-3">
              <span className="text-xs font-bold tracking-[0.2em] text-cod-orange">STATUS:</span>
              <span className="text-xs font-mono text-white/80 tracking-wider">NOT OFFICIALLY LAUNCHED</span>
            </div>
